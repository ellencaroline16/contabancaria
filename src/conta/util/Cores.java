...
public class Cores { // classe principal do projeto
	...
	//Reset Color
			...
			// Text Color Bold High Intensity - cor mais clara + negrito
			...
			// Background Color - cor mais clara p/ o final
